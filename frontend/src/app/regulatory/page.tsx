      ...
      <section className="bg-white py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { Icon: Shield, title: "CMA Kenya", desc: "Licensed by the Capital Markets Authority of Kenya.", badge: "Regulated" },
              { Icon: Shield, title: "NSE Member", desc: "Registered member of the Nairobi Securities Exchange.", badge: "Registered" },
              { Icon: Shield, title: "CDSC", desc: "All securities held in client-segregated CDSC accounts.", badge: "Registered" },
