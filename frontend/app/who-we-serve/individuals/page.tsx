    ...
    <>
      <section className="bg-[#0a4f3c] pt-32 pb-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-white/70 text-xl max-w-2xl">Whether you&apos;re saving your first KES 500 or building a multi-million portfolio — Zanari is built for your journey.</p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">We built Zanari to answer first-time investor questions, not dismiss them.</p>
              <ul className="space-y-3">
                {[
                  "Minimum deposit: KES 100 — less than a cup of coffee",
            ...
            <div className="bg-[#f8f5ef] rounded-2xl p-8">
              ...
              <div className="space-y-4">
                {[
                  { step: "S", title: "Open your Zanari account", desc: "10-minute remote KYC, no branch visit needed" },
                  { step: "F", title: "Deposit with M-Pesa", desc: "From KES 100. Instant, zero fees" },
      ...
      <section className="bg-[#063328] py-16 text-center">
        <div className="max-w-xl mx-auto px-4">
          ...
          <Link href="/products/zanari">
            <Button variant="secondary" size="lg" className="gap-2">Join Zanari Waitlist <ArrowRight className="w-5 h-5" /></Button>
          </Link>
        </div>
      </section>
    </>
