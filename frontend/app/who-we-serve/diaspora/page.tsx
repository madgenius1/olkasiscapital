    ...
    <>
      <section className="bg-[#0a4f3c] pt-32 pb-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-5xl font-bold text-white mb-6">You&apos;re in London.<br /><span className="text-[#c9a84c]">Your money grows in Nairobi.</span></h1>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { title: "Multi-currency deposits", desc: "Deposit in USD, GBP, or EUR. We handle the KES conversion at competitive FX rates (market rate + 0.5%)." },
      ...
      <section className="bg-[#f8f5ef] py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[{ code: "KES", label: "Kenyan Shilling" }, { code: "USD", label: "US Dollar" }, { code: "GBP", label: "British Pound" }, { code: "EUR", label: "Euro" }].map(({ code, label }) => (
