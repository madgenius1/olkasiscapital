        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
          <div className="max-w-5xl">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white leading-tight mb-6">
              Africa&apos;s wealth,
              <br />
              <span className="text-[#c9a84c]">invested wisely</span>— from
              Nairobi to the world.
            </h1>
            <p className="text-xl text-white/70 leading-relaxed mb-10 max-w-2xl">
              Olkasis Capital brings institutional-grade investment to everyday
              Africans. Whether you&apos;re in Nairobi, London, or Toronto —
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-8">
                Zanari is Kenya&apos;s most accessible investment platform. Fund
                with Mobile Money, Bank, and Online Systems, buy NSE stocks and ETFs, and get personalized
                guidance from <span className="font-bold">Rafiki</span> — your AI investment advisor.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                quote:
                  "Finally, a platform built for Kenyans by people who understand Kenya. The M-Pesa integration alone changes everything.",
                author: "Beta tester, Nairobi",
                role: "Individual Investor",
              },
              {
                quote:
                  "As a SACCO treasurer, we've been looking for a compliant, transparent platform. Olkasis Capital delivers exactly that.",
                author: "SACCO Official, Mombasa",
                role: "Institutional Partner",
              },
              {
                quote:
                  "I live in London but my money grows in Kenya. The remote KYC process was seamless — took under 10 minutes.",
                author: "Diaspora Investor, UK",
      ...
      <section className="bg-[#0a4f3c] py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/70 text-lg leading-relaxed mb-10">
            For too long, African savings have sat in low-yield accounts while
            the world&apos;s wealth compounds elsewhere. We are building the
            infrastructure for a new generation of African wealth.
          </p>
          <Link href="/about">
